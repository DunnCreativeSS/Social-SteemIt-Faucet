		  ...
		  .then(function(replies) {
			...
			if (reps.length != 0){
				...
				if (!authors.includes(replies[a].author)){
						...
						steem.broadcast.comment('5JSwxdnsPMgYYhkHN6rpGLtihZfwhz2LHnnZYKCYKkQsxr7EwTg', replies[a].author, permlink, 'hodlorbust', 'steem', '', 'Sending you ' +toSendSbd + ' SBD and ' + toSendBalance + ' STEEM! Woot!', '', function(err, result) {
						  console.log(err, result);
						});
